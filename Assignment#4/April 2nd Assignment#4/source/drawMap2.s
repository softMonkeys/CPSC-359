...
// Draw the 32x32 "mushRoom" cell
drawnumberThree:
ldr   r6, =numberThree    // Load the address of "StraightLine" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle61" cell
drawCastle61:
ldr   r6, =Castle61    // Load the address of "Castle61" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle62" cell
drawCastle62:
ldr   r6, =Castle62    // Load the address of "Castle62" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle63" cell
drawCastle63:
ldr   r6, =Castle63    // Load the address of "Castle63" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle64" cell
drawCastle64:
ldr   r6, =Castle64    // Load the address of "Castle64" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle65" cell
drawCastle65:
ldr   r6, =Castle65    // Load the address of "Castle65" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle66" cell
drawCastle66:
ldr   r6, =Castle66    // Load the address of "Castle66" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle67" cell
drawCastle67:
ldr   r6, =Castle67    // Load the address of "Castle67" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
...
// Draw the 32x32 "Castle68" cell
drawCastle68:
ldr   r6, =Castle68    // Load the address of "Castle68" in "data.s"
ldr   r7, =32   // Width of the picture
ldr   r8, =32    // Height of the picture
